...
public class OracleGenerateSql extends AbstractGenrateSql {
		...
		if (destDbtype == sourceDbType) {
			...
			case MSSQL:
				cols.forEach(col -> {
					...
					case BIGINT:
						...
						break;
					case FLOAT:
						if (col.getColumnSize() > 53) {
							subStrBuf.append(col.getColumnName() + " FLOAT(53)");
						} else {
					...
					case DECIMAL:
						...
						if (size > 0) {
							...
							subStrBuf.append(col.getColumnName() + " DECIMAL");
						}
						break;
					case CHAR:
			...
			case MYSQL:
				cols.forEach(col -> {
					...
					switch (colType) {
					case BIT:
						subStrBuf.append(col.getColumnName() + " BIT(" + col.getColumnSize() + ")");
						break;
					case TINYINT:
						subStrBuf.append(col.getColumnName() + " TINYINT");
						break;
					...
					case BLOB:
						...
						break;
					case CLOB:
						subStrBuf.append(col.getColumnName() + "  LONGCLOB");
						break;
					case NCHAR:
						subStrBuf.append(col.getColumnName() + " NCHAR(" + col.getColumnSize() + ")");
						break;
